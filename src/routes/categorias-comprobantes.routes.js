...
const { getCategoriaComprobanteById, getCategoriasComprobantes } = require('../controllers/categorias-comprobantes.controller');
...
// GET /api/categorias/:id - Obtener comprobante por ID (DEBE IR PRIMERO)
router.get('/comprobantes/:id', getCategoriaComprobanteById);

// GET /api/categorias - Obtener lista de categorias con paginación
router.get('/comprobantes', getCategoriasComprobantes);
