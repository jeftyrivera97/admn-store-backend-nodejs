...
// GET /api/categorias/compras - Con paginación y búsqueda
const getCategoriasCompras = async (req, res) => {
  try {
    ...
    const [categorias, total] = await Promise.all([
      ...
      prisma.categorias_compras.findMany({
      ...
      prisma.categorias_compras.count({ where: whereCondition })
    ]);
...
// GET /api/categorias/compras/:id
const getCategoriaCompraById = async (req, res) => {
  try {
    ...
    const categoria = await prisma.categorias_compras.findUnique({
      where: { 
        id: BigInt(id)
      },
      include: {
...
module.exports = {
  getCategoriasCompras,    // GET /api/categorias/compras
  getCategoriaCompraById,  // GET /api/categorias/compras/:id
};