...
// GET /api/categorias/empleados - Con paginación y búsqueda
const getCategoriasEmpleados = async (req, res) => {
  try {
    ...
    const [categorias, total] = await Promise.all([
      ...
      prisma.categorias_empleados.findMany({
      ...
      prisma.categorias_empleados.count({ where: whereCondition })
    ]);
...
// GET /api/categorias/empleados/:id
const getCategoriaEmpleadoById = async (req, res) => {
  try {
    ...
    const categoria = await prisma.categorias_empleados.findUnique({
      where: { 
        id: BigInt(id)
      },
      include: {
...
module.exports = {
  getCategoriasEmpleados,    // GET /api/categorias/empleados
  getCategoriaEmpleadoById,  // GET /api/categorias/empleados/:id
};