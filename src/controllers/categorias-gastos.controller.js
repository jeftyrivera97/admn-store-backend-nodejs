...
// GET /api/categorias/gastos - Con paginación y búsqueda
const getCategoriasGastos = async (req, res) => {
  try {
    ...
    const [categorias, total] = await Promise.all([
      ...
      prisma.categorias_gastos.findMany({
      ...
      prisma.categorias_gastos.count({ where: whereCondition })
    ]);
...
const getCategoriaGastoById = async (req, res) => {
  try {
    ...
    const categoria = await prisma.categorias_gastos.findUnique({
      where: { 
        id: BigInt(id)
      },
      include: {
...
module.exports = {
  getCategoriasGastos,    // GET /api/categorias/gastos
  getCategoriaGastoById,  // GET /api/categorias/gastos/:id
};