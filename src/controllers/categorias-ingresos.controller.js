...
const getCategoriasIngresos = async (req, res) => {
  try {
    ...
    const [categorias, total] = await Promise.all([
      ...
      prisma.categorias_ingresos.findMany({
      ...
      prisma.categorias_ingresos.count({ where: whereCondition })
    ]);
...
// GET /api/categorias/ingresos/:id
const getCategoriaIngresoById = async (req, res) => {
  try {
    ...
    const categoria = await prisma.categorias_ingresos.findUnique({
      where: { 
        id: BigInt(id)
      },
      include: {
...
module.exports = {
  getCategoriasIngresos,    // GET /api/categorias/ingresos
  getCategoriaIngresoById,  // GET /api/categorias/ingresos/:id
};